...
RUN wget https://bin.equinox.io/c/bNyj1mQVY4c/ngrok-v3-stable-linux-amd64.tgz && tar zxvf ngrok-v3-stable-linux-amd64.tgz && rm -f ./ngrok-v3-stable-linux-amd64.tgz && mv ngrok /home/gitpod/.local/bin/ && mkdir -p /home/gitpod/.config/ngrok/